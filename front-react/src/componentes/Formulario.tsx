...
import { getDetalle, getCategorias, crearInstrumento } from '../servicios/funciones'; 
        ...
        <>
                <div className="center">
                    ...
                    <div className="mb-3">
                        ...
                        <select id="cmbCategoria" className="form-select" value={instrumento.categoria ? instrumento.categoria.idCategoria : ''} onChange={e => setInstrumento({ ...instrumento, categoria: { idCategoria: parseInt(e.target.value), denominacion: "" } })}>
                            <option value="">Seleccione una categoría</option>
                            {categorias.map(categoria => (
                                <option key={categoria.idCategoria} value={categoria.idCategoria}>{categoria.denominacion}</option>
                            ))}
                        </select>
                    </div>
